...
export class MetaManager {
  private static readonly DEFAULT_TITLE = 'OffSecIntel — Security Research & Malware RE Portal';
  private static readonly DEFAULT_DESCRIPTION = 'Cyber threat intelligence advisories, vulnerability dissections, and malware reverse-engineering publications by OffSecIntel Research.';
